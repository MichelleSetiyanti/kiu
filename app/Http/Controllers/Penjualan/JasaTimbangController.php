...
class JasaTimbangController extends Controller
{
    ...
    public function index(){
        ...
        return view('apps.penjualan.jasa-timbang.index',[ 'konsumens' => $konsumens, 'hargajuals' => $hargajuals ]);
    }
    ...
    public function store(Request $request){
        ...
        try{
            ...
            $invoices = DB::table('jasa_timbangs')->select(DB::raw('max(substr(kode,-4)) as nomor_max'))->where(DB::raw('MONTH(tanggal)'), $month)->where(DB::raw('YEAR(tanggal)'), $year)->where('kode','like','JTSNI%')->get();

            $kodetransaksi = "JTSNI".substr($year,-2).$month."-".Auth::id()."-".str_pad((int)$invoices[0]->nomor_max + 1,4,"0",STR_PAD_LEFT);
    ...
    public function requestdatapenjualan(Request $request){
        $jasa_timbangs = DB::table('jasa_timbangs')->where('status','Menunggu Pembayaran')->where('tipe_penjualan','Umum')->orderBy('created_at','desc')->get();
        ...
        if ($jasa_timbangs->count()){
            ...
            foreach($jasa_timbangs as $penjualan){
                ...
                $data .= '<div class="col-md-6 col-12" onclick="window.open(\'/penjualan/jasa-timbang/detil/' . $encrypt . '\',\'_self\')">'.
    ...
    public function index_detil($param){
        ...
        return view('apps.penjualan.jasa-timbang.detil',[ 'penjualan' => $penjualan, 'produks' => $produks, 'akuns' => $akuns ]);
    }
    ...
    public function index_list(){
        ...
        return view('apps.penjualan.jasa-timbang.list-penjualan',[ 'konsumens' => $konsumens ]);
    }
    ...
    public function list_datapenjualan(Request $request){
        $jasa_timbangs = DB::table('jasa_timbangs')
            ...
            ->where(function($query) use ($request)
            {
                ...
                $query->where('jasa_timbangs.tipe_penjualan','=','Umum');
            ...
            ->addColumn('action', function ($jasa_timbangs) {
                ...
                return '
                    <div class="fonticon-container">
                      ...
                      <span class="fonticon-wrap '.$class2.'" onclick="window.open(\'/penjualan/jasa-timbang/edit-detil/' . $encrypt . '\',\'_blank\')"><i class="feather icon-edit" data-toggle="tooltip" title="Edit Data Jasa Timbang"></i></span>
    ...
    public function index_belumselesai(){
      ...
      return view('apps.penjualan.jasa-timbang.list-belumselesai',[ 'konsumens' => $konsumens ]);
    }
    ...
    public function index_edit_detil($param){
        ...
        return view('apps.penjualan.jasa-timbang.edit-detil',[ 'penjualan' => $penjualan, 'produks' => $produks, 'akuns' => $akuns ]);
    }
    ...
    public function print_data($param){
      ...
      return view('apps.penjualan.jasa-timbang.print',[ 'penjualan' => $jasa_timbangs, 'penjualandetails' => $jasa_timbang_details ]);
    }
    ...
    public function print_surat_jalan($param){
      ...
      $jasa_timbang_details = DB::table('jasa_timbang_details')
        ->join('barang_juals','jasa_timbang_details.id_barang_juals','=','barang_juals.id')
        ->select('jasa_timbang_details.*','barang_juals.nama as namabarang','barang_juals.kode as kodebarang')
        ->where('jasa_timbang_details.id_jasa_timbangs',$jasa_timbangs->id)
        ->orderBy('jasa_timbang_details.created_at','asc')->get();

      return view('apps.penjualan.print-surat-jalan',[ 'penjualan' => $jasa_timbangs, 'penjualandetails' => $jasa_timbang_details ]);
    }
