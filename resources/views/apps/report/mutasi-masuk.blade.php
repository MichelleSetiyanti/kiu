...
@section('title', 'Laporan Mutasi Penambahan Stok Barang Pabrik')
@section('page-title', 'Laporan Mutasi Penambahan Stok Barang Pabrik')
...
@section('page-script')
  ...
  <script>
    ...
    function f_loadtable(){
      ...
      let link = "/report/mutasi-masuk/list" +
