...
<head>
  ...
  <title> Kartu Piutang Penampung </title>
        ...
        <div class="card-body p-0">
          <div class="invoice-container">
            <div class="invoice-header">
              ...
              <h2 style="color:#232F33;width:100%;text-align:center;font-family:'Poppins', sans-serif;"> Kartu Piutang Penampung </h2>
              <h3 style="color:#e31515;width:100%;text-align:center;font-family:'Poppins', sans-serif;">
                @php
                  $penampung = DB::table('penampungs')->where('id',$request->penampung)->first();
                @endphp
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="table-responsive">
                    <table class="table custom-table m-0">
                      <thead>
                      <tr>
                        <th style="text-align:center;font-size:26px;border-bottom:1px solid white;" colspan="5">Peminjaman</th>
                      </tr>
                      <tr>
                      ...
                      @endforeach
                      <tr>
                        <td colspan="4" style="text-align:right;padding-right:10px;font-size:22px;font-weight:bold;"> Total Peminjaman </td>
                    ...
                    <table class="table custom-table m-0 mt-5">
                      <thead>
                      <tr>
                        <th style="text-align:center;font-size:26px;border-bottom:1px solid white;" colspan="5">Pengembalian</th>
                      </tr>
                      <tr>
                        <th style="text-align:center;width:50px;">No</th>
                        <th style="text-align:center;width:170px;">Tanggal</th>
                      ...
                      @endforeach
                      <tr>
                        <td colspan="4" style="text-align:right;padding-right:10px;font-size:22px;font-weight:bold;"> Total Pengembalian </td>
                    ...
                    <table class="table custom-table m-0 mt-5">
                      ...
                      <tr>
                        <td colspan="4" style="text-align:right;padding-right:10px;font-size:22px;font-weight:bold;"> Sisa Pinjaman </td>
...
<script>
  ...
  function f_simpan(){
    ...
    html2canvas($(".html-content")[0],{scale:4}).then(function (canvas) {
      ...
      pdf.save("Laporan Kartu Piutang Penampung.pdf");
      $(".no-print").show();
    });
  }
</script>
