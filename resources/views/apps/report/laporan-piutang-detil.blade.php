        ...
        <div class="card-body p-0">
          <div class="invoice-container">
            <div class="invoice-header">
              ...
              <h2 style="color:#232F33;width:100%;text-align:center;font-family:'Poppins', sans-serif;"> LAPORAN PIUTANG </h2>
              <h5 style="color:#232F33;width:100%;text-align:center;font-family:'Poppins', sans-serif;font-weight:normal;"> Periode {{ Carbon\Carbon::createFromFormat('m-Y', $request->tanggalmulai)->isoFormat('MMMM Y') }} s/d {{ Carbon\Carbon::createFromFormat('m-Y', $request->tanggalselesai)->isoFormat('MMMM Y') }} </h5>
                  ...
                  <div class="table-responsive">
                    <table class="table custom-table m-0">
                      ...
                      <tr>
                        ...
                        <th style="text-align:center;vertical-align:middle" colspan="{{ $diff+1 }}">BULAN</th>
                        <th style="text-align:center;vertical-align:middle" rowspan="2">Nominal (Rp)</th>
                      </tr>
                      <tr>
                        @for($x=0;$x<=$diff;$x++)
                          <th style="text-align:center;">{{ Carbon\Carbon::createFromFormat('m-Y', $request->tanggalmulai)->addMonths($x)->isoFormat('MMM Y') }} </th>
                        @endfor
                      </tr>
                      </thead>
                      <tbody>
