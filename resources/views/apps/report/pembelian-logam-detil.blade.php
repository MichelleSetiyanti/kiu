...
<head>
  ...
  <title> Laporan Pembelian Logam Detil </title>
        ...
        <div class="card-body p-0">
          <div class="invoice-container">
            <div class="invoice-header">
              ...
              <h2 style="color:#232F33;width:100%;text-align:center;font-family:'Poppins', sans-serif;"> LAPORAN PEMBELIAN DETIL LOGAM </h2>
                    ...
                    <table class="table custom-table m-0">
                      ...
                      @foreach($barangs ?? '' as $barang)
                        @php
                          ...
                          ->select(DB::raw('sum(pembelian_details.netto) as totalnetto'),DB::raw('sum(pembelian_details.potongan) as totalpotongan'),DB::raw('sum(pembelian_details.total_beli) as totalbeli'))
