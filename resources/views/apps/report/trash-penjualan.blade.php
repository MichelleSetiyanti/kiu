...
@section('title', 'Laporan Daftar Penjualan Terhapus')
@section('page-title', 'Laporan Daftar Penjualan Terhapus')
...
@section('page-script')
  ...
  <script>
    ...
    function f_loadtable(){
      ...
      let link = "/report/trash-penjualan/list" +
    ...
    function f_loaddetil(){
      ...
      let link = "/report/trash-penjualan/list-detil" +
        "?tanggalmulai=" + tanggalmulai +
        "&tanggalselesai=" + tanggalselesai +
        "&client=" + client +
        "&jenis=" + jenis +
    ...
    function f_datadetil(param){
        ...
        let dataListView = $(".data-list-view-detail").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "/report/trash-penjualan/list-detils?id="+param,
            columns: [
