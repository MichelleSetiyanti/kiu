...
@section('title', 'Laporan Mutasi Pengurangan Stok Barang Pabrik')
@section('page-title', 'Laporan Mutasi Pengurangan Stok Barang Pabrik')
  ...
  <section id="data-list-view" class="data-list-view-header card" style="padding:25px 15px;">
    <div class="col-md-12">
      <div class="row">
        ...
        <div class="col-sm-12 col-md-6 mt-1">
          <label for="produks">Barang Beli</label>
    ...
    <div class="table-responsive hidden mt-1" id="tabel">
      <table class="table data-list-view" style="border:none;width:100%;">
        ...
        <tfoot>
        <tr>
          <th colspan="4" style="font-size:18px;text-align:right;"></th>
...
@section('page-script')
  ...
  <script>
    ...
    function f_loadtable(){
      ...
      let link = "/report/mutasi-keluar/list" +
      ...
      dataListView = $(".data-list-view").DataTable({
        ...
        "footerCallback": function ( row, data, start, end, display ) {
          ...
          $( api.column( 4 ).footer() ).html(''+accounting.formatNumber(Total1, 2, ".", ","));
        },
      });
    }
