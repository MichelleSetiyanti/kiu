...
@section('title', 'Laporan Laba Rugi Perdivisi')
@section('page-title', 'Laporan Laba Rugi Perdivisi')
    ...
    <div class="col-md-12">
      <div class="row">
        ...
        <div class="col-sm-12 col-md-12 mt-1">
          ...
          <select class="form-control select" name="divisi" id="divisi">
            <option data-foo="" value="Umum">Umum</option>
            <option data-foo="" value="Logam">Logam</option>
          </select>
        </div>

        <div class="col-sm-12 col-md-12 mt-2">
          <button type="button" id="btnsearch" name="btnsearch" onclick="f_loaddetil()" class="btn bg-gradient-info waves-effect waves-light"> <i class="feather icon-list" style="margin-right:8px;"></i> Lihat Laba Rugi Perdivisi </button>
        </div>
  ...
  <script>
    ...
    function f_loaddetil(){
        ...
        if(tanggalmulai == "" || tanggalselesai == ""){
            alert('Pilih tanggal untuk melihat Laporan');
            return;
        }

        let link = "/report/laporan-lr-perdivisi/list-detil" +
