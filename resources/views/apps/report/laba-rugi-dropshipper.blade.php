...
@section('title', 'Laporan Laba Rugi Dropshipper')
@section('page-title', 'Laporan Laba Rugi Dropshipper')
    ...
    <div class="col-md-12">
      ...
      <div class="row html-content hidden mb-4" id="detil">
        ...
        <div class="col-md-9" style="font-size:18px;color:black;margin:auto;">
          ...
          <h2 class="text-center"> <b>Laporan Laba Rugi Dropshipper</b> </h2>
    ...
    function f_loaddata(){
      ...
      if(tanggalmulai != "" && tanggalselesai != ""){
        if(tanggalselesai >= tanggalmulai){
            $.post('/report/laba-rugi-dropshipper/get-data',{tanggalmulai: tanggalmulai, tanggalselesai: tanggalselesai, _token: '{{csrf_token()}}'})
                .done(function(data){
