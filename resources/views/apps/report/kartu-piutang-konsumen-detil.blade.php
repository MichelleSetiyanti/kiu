        ...
        <div class="card-body p-0">
          <div class="invoice-container">
            <div class="invoice-header">
              ...
              <h2 style="color:#232F33;width:100%;text-align:center;font-family:'Poppins', sans-serif;"> Kartu DP Konsumen </h2>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="table-responsive">
                    <table class="table custom-table m-0">
                      <thead>
                      <tr>
                        <th style="text-align:center;font-size:26px;border-bottom:1px solid white;" colspan="5">DP Konsumen</th>
                      </tr>
                      <tr>
                      ...
                      @endforeach
                      <tr>
                        <td colspan="4" style="text-align:right;padding-right:10px;font-size:22px;font-weight:bold;"> Total DP Konsumen </td>
                    ...
                    <table class="table custom-table m-0 mt-5">
                      <thead>
                      <tr>
                        <th style="text-align:center;font-size:26px;border-bottom:1px solid white;" colspan="5">Pengembalian DP Konsumen</th>
                      </tr>
                      <tr>
                        <th style="text-align:center;width:50px;">No</th>
                        <th style="text-align:center;width:170px;">Tanggal</th>
                      ...
                      @endforeach
                      <tr>
                        <td colspan="4" style="text-align:right;padding-right:10px;font-size:22px;font-weight:bold;"> Total Pengembalian DP Konsumen </td>
                    ...
                    <table class="table custom-table m-0 mt-5">
                      <thead>
                      <tr>
                        <th style="text-align:center;font-size:26px;border-bottom:1px solid white;" colspan="5">Potong Penjualan</th>
                      </tr>
                      <tr>
                        <th style="text-align:center;width:50px;">No</th>
                        <th style="text-align:center;width:170px;">Tanggal</th>
                      ...
                      @foreach($bayarhutangs ?? '' as $bayarhutang)
                        ...
                        <tr>
                          ...
                          <td>Potongan Pelunasan Untuk Transaksi Penjualan Dengan Kode : @foreach($penjualan_details ?? '' as $penjualandetail) {{ $penjualandetail->kode }}@if(!$loop->last), @endif @endforeach</td>
                      ...
                      @endforeach
                      <tr>
                        <td colspan="4" style="text-align:right;padding-right:10px;font-size:22px;font-weight:bold;"> Total Potong Penjualan </td>
                        <td style="text-align:right;padding-right:10px;font-size:22px;font-weight:bold;">{{ number_format($sumsbayarhutang,0,',','.') }}</td>
                      </tr>
                      <tr>
                        <td colspan="4" style="text-align:right;padding-right:10px;font-size:22px;font-weight:bold;"> Sisa DP </td>
                        <td style="text-align:right;padding-right:10px;font-size:22px;font-weight:bold;">{{ number_format($sumspinjaman - $sumspengembalian - $sumsbayarhutang,0,',','.') }}</td>
                      </tr>
                      </tbody>
                    </table>
...
<script>
  ...
  function f_simpan(){
    ...
    html2canvas($(".html-content")[0],{scale:4}).then(function (canvas) {
      ...
      pdf.save("Laporan Kartu DP Konsumen.pdf");
      $(".no-print").show();
    });
  }
</script>
