...
@section('title', 'Laporan Daftar Pelunasan Hutang')
@section('page-title', 'Laporan Daftar Pelunasan Hutang')
...
@section('page-script')
  ...
  <script>
    ...
    function f_loadtable(){
      ...
      let link = "/report/pelunasan-hutang/list" +
      ...
      dataListView = $(".data-list-view").DataTable({
        ...
        columns: [
          ...
          {data: 'statuspelunasan', name: 'statuspelunasan',render: function ( data, type, row, meta ) {
              if(data == 'Cancel'){
