...
@section('title', 'Laporan Daftar Cancel Pelunasan Piutang')
@section('page-title', 'Laporan Daftar Cancel Pelunasan Piutang')
...
@section('page-script')
  ...
  <script>
    ...
    function f_loadtable(){
      ...
      let link = "/report/cancel-pelunasan-piutang/list" +
