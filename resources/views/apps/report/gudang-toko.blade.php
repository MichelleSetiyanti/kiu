...
@section('title', 'Laporan Mutasi Pabrik ke Toko')
@section('page-title', 'Laporan Mutasi Pabrik ke Toko')
  ...
  <script>
    ...
    function f_loadtable(){
        ...
        let dataListView = $(".data-list-view").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "/report/gudang-toko/list?tanggalmulai=" + tanggalmulai + "&tanggalselesai=" + tanggalselesai + "&produks=" + produks,
            columns: [
