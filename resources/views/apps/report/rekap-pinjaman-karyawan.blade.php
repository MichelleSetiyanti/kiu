...
@section('title', 'Rekap Pinjaman Karyawan')
@section('page-title', 'Rekap Pinjaman Karyawan')
  ...
  <script>
    ...
    function f_loadtable(){
      let dataListView = $(".data-list-view").DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: "/report/rekap-pinjaman-karyawan/list",
        columns: [
          ...
          {data: 'pinjaman', name: 'pinjaman', render: $.fn.dataTable.render.number( '.', ',', 0, 'Rp ' )}
        ],
        responsive: false,
        columnDefs: [
          {
