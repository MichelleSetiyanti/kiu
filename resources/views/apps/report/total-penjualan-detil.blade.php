...
<head>
  ...
  <title> Laporan Total Penjualan per Konsumen </title>
                    ...
                    <table class="table custom-table m-0">
                      ...
                      @foreach($konsumens ?? '' as $konsumen)
                        @php
                          ...
                          ->select(DB::raw('sum(grandtotal) as totaljual'))
                      ...
                      @endforeach
                      <tr>
                        <td colspan="2" style="text-align:right;padding-right:10px;font-size:22px;font-weight:bold;"> TOTAL : </td>
