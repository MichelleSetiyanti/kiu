...
@section('title', 'Laporan Kantor')
@section('page-title', 'Laporan Kantor')
    ...
    <div class="col-md-12">
      <div class="row">
        ...
        <div class="col-sm-12 col-md-12 mt-1">
          <label for="akun">Filter Akun</label>
...
{{--            <option value="All" data-foo="" selected> Semua Akun </option>--}}
        ...
        <div class="col-sm-12 col-md-12 mt-2">
          <button type="button" id="btnsearch" name="btnsearch" onclick="f_loaddetil()" class="btn bg-gradient-info waves-effect waves-light"> <i class="feather icon-list" style="margin-right:8px;"></i> Lihat Laporan Kantor </button>
        </div>
...
@section('page-script')
  ...
  <script>
    ...
    function f_loaddetil(){
        ...
        let link = "/report/laporan-kantor/list-detil" +
