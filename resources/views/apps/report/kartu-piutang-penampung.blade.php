...
@section('title', 'Kartu Piutang Penampung')
@section('page-title', 'Kartu Piutang Penampung')
    ...
    <div class="col-md-12">
      <div class="row">
        ...
        <div class="col-sm-12 col-md-12 mt-1">
          <label for="client"> Filter Penampung</label>
  ...
  <script>
    ...
    function f_loaddetil(){
        ...
        if(tanggalmulai == "" || tanggalselesai == ""){
            alert('Pilih tanggal untuk melihat Laporan Piutang Penampung');
            return;
        }

        let link = "/report/kartu-piutang-penampung/list-detil" +
