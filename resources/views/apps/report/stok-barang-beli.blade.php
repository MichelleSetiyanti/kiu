  ...
  <section id="data-list-view" class="data-list-view-header card" style="padding:25px 15px;">
    ...
    <div class="table-responsive hidden mt-1" id="tabel">
      <table class="table data-list-view" style="border:none;width:100%;">
        ...
        <tfoot>
        <tr>
          <th colspan="5" style="font-size:18px;text-align:right;"></th>
...
@section('page-script')
  ...
  <script>
    ...
    function f_loadtable(){
      ...
      let link = "/report/stok-barang-beli/list?kategori="+kategori ;
      ...
      dataListView = $(".data-list-view").DataTable({
        ...
        ajax: link,
        columns: [
          {data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false,render: function ( data, type, row, meta ) {
              if(data == 1){
                  subtotal = 0;
              }
          ...
          {data: 'stok', name: 'stok', render: $.fn.dataTable.render.number( '.', ',', 2, '' )},
          {data: 'gudang', name: 'gudang', render: $.fn.dataTable.render.number( '.', ',', 2, '' )}
        ],
        scrollX: true,
        scrollCollapse: true,
        columnDefs: [
        ...
        "footerCallback": function ( row, data, start, end, display ) {
            ...
            $( api.column( 5 ).footer() ).html(accounting.formatNumber(Total1, 2, ".", ","));
            $( api.column( 6 ).footer() ).html(accounting.formatNumber(Total2, 2, ".", ","));
        },
      });
    }
