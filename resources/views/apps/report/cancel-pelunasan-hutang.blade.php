...
@section('title', 'Laporan Daftar Cancel Pelunasan Hutang')
@section('page-title', 'Laporan Daftar Cancel Pelunasan Hutang')
      ...
      <div class="row">
        ...
        <div class="col-sm-12 col-md-6 mt-1">
            ...
            <select class="form-control select" name="akun" id="akun">
                <option value="All" data-foo="" selected> Semua Akun </option>
        ...
        <div class="col-sm-12 col-md-6 mt-1 hidden">
            <label for="status"> Status Pelunasan </label>
            <select class="form-control select" name="status" id="status">
                <option data-foo="" value="Paid">Lunas</option>
{{--                <option data-foo="" value="Cancel">Dibatalkan</option>--}}
            </select>
        </div>
    ...
    <div class="table-responsive hidden mt-1" id="tabel">
      <table class="table data-list-view" style="border:none;width:100%;">
        ...
        <tr>
          ...
          <th>Akun Pengembalian</th>
          <th>Status</th>
        </tr>
        </thead>
        <tfoot>
        <tr>
          <th colspan="6" style="font-size:18px;text-align:right;"></th>
...
@section('page-script')
  ...
  <script>
    ...
    function f_loadtable(){
      ...
      let link = "/report/cancel-pelunasan-hutang/list" +
      ...
      dataListView = $(".data-list-view").DataTable({
        ...
        columns: [
          ...
          {data: 'totalpelunasan', name: 'totalpelunasan', render: $.fn.dataTable.render.number( '.', ',', 2, 'Rp ' )},
          {data: 'namauser', name: 'namauser'},
          {data: 'waktupelunasan', name: 'waktupelunasan',render: function ( data, type, row, meta ) {
              if(data != null){
          ...
          {data: 'namaakun', name: 'namaakun',render: function ( data, type, row, meta ) {
