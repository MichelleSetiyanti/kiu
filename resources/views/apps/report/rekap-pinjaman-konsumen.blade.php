...
@section('title', 'Laporan Limit Piutang Konsumen')
@section('page-title', 'Laporan Limit Piutang Konsumen')
  ...
  <script>
    ...
    function f_loadtable(){
      let dataListView = $(".data-list-view").DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: "/report/rekap-pinjaman-konsumen/list",
        columns: [
          ...
          {data: 'limit_piutang', name: 'limit_piutang', render: $.fn.dataTable.render.number( '.', ',', 0, 'Rp ' )},
          {data: 'piutang', name: 'piutang', render: $.fn.dataTable.render.number( '.', ',', 0, 'Rp ' )}
        ],
        responsive: false,
        columnDefs: [
          {
