    ...
    <div class="col-md-12">
      <div class="row">
        ...
        <div class="col-sm-12 col-md-12 mt-2">
          <button type="button" id="btnsearch" name="btnsearch" onclick="f_loaddetil()" class="btn bg-gradient-info waves-effect waves-light"> <i class="feather icon-list" style="margin-right:8px;"></i> Lihat Data Mutasi </button>
        </div>
  ...
  <script>
    ...
    function f_loaddetil(){
        ...
        if(tanggalmulai == "" || tanggalselesai == ""){
            alert('Pilih tanggal untuk melihat Laporan Mutasi Barang');
            return;
        }

        let link = "/report/mutasi-barang/list-detil" +
