...
@section('title', 'Laporan Bulk Payroll')
@section('page-title', 'Laporan Bulk Payroll')
...
@section('page-script')
  ...
  <script>
    ...
    function f_loadtable(){
      ...
      let link = "/report/bulk-payroll/list" +
      ...
      dataListView = $(".data-list-view").DataTable({
        ...
        columns: [
          {data: 'kode', name: 'kode'},
          {data: 'tanggal_gaji', name: 'tanggal_gaji',render: function ( data, type, row, meta ) {
              if(data != null){
          ...
          {data: 'tanggal_mulai', name: 'tanggal_mulai',render: function ( data, type, row, meta ) {
              if(data != null){
                  return moment(data).locale('id').format('DD MMMM YYYY');
              }else{
                  return '-';
          ...
          {data: 'tanggal_selesai', name: 'tanggal_selesai',render: function ( data, type, row, meta ) {
              if(data != null){
                  return moment(data).locale('id').format('DD MMMM YYYY');
              }else{
                  return '-';
          ...
          {data: 'jenis_gaji', name: 'jenis_gaji'},
          ...
          {data: 'totalakhir', name: 'totalakhir', render: $.fn.dataTable.render.number( '.', ',', 0, '' )},
    ...
    function f_loaddetil(){
        ...
        let link = "/report/bulk-payroll/list-detil" +
            "?tanggalmulai=" + tanggalmulai +
            "&tanggalselesai=" + tanggalselesai +
            "&status=" + status;
