...
@section('title', 'List Pelunasan Piutang Penjualan')
@section('page-title', 'List Pelunasan Piutang Penjualan')
...
@section('content')
  ...
  <section id="data-list-view" class="data-list-view-header card" style="padding:25px 15px;">
    ...
    <div class="col-sm-12 col-md-12 mb-2 hidden">
      <label for="akuns">Pilih Akun Pengembalian</label>
...
@section('page-script')
  ...
  <script>
    ...
    function f_loadtable(){
      let link = "/penjualan/cancel-pelunasan/list";
      ...
      dataListView = $(".data-list-view").DataTable({
          ...
          columns: [
              ...
              {data: 'totalpelunasan', name: 'totalpelunasan', render: $.fn.dataTable.render.number( '.', ',', 0, 'Rp ' )},
    ...
    function f_prosespelunasan(id,nominal){
      Swal.fire({
          title: 'Konfirmasi',
          text: "Apakah anda yakin untuk membatalkan pelunasan data ini?",
          type: 'warning',
          ...
          if (result.value) {
              ...
              let link = "/penjualan/cancel-pelunasan/pelunasan"; // Link default untuk simpan

              $.post(link,{id:id,nominal:nominal,akun:akuns, _token: '{{csrf_token()}}'})
                  .done(function(data){
                      if(data == "berhasil"){
