    ...
    <section id="data-list-view" class="data-list-view-header card" style="padding:25px 15px;">
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6">
                    <button type="button" id="btnsearch" name="btnsearch" onclick="f_loadtable()"
                        class="btn bg-gradient-success waves-effect waves-light mt-2"> <i class="feather icon-search"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 mb-1 data-field-col">
                                ...
                                <input type="text" class="form-control date" name="tanggal" id="tanggal"
                                    placeholder="Tanggal Surat Jalan" required>
                            </div>
                        </div>
    ...
    <script>
        ...
        function f_loadtable() {
            ...
            dataListView = $(".data-list-view").DataTable({
                ...
                dom: '<"top"<"action-filters"Blf>><"clear">rt<"bottom"<"actions">pi>',
                oLanguage: {
                    sLengthMenu: "_MENU_",
                    sSearch: ""
                },
