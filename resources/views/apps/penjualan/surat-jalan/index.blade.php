  ...
  <section id="data-list-view" class="data-list-view-header card" style="padding:25px 15px;">
    ...
    <div class="modal fade text-left" id="modal3" tabindex="-1" role="dialog"
      ...
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-sm" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title" id="myModalLabel3">Pilih Tanggal Surat Jalan</h4>
          ...
          <div class="modal-body" style="height:300px;">
            ...
            <div class="row">
              ...
              <div class="col-sm-12 mb-1 data-field-col">
                <label for="tanggal">Tanggal Surat Jalan</label>
                <input type="text" class="form-control date" name="tanggal" id="tanggal" placeholder="Tanggal Surat Jalan" required>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-sm-12 mb-1 data-field-col">
                ...
                <input type="text" class="form-control" name="ekspedisi" id="ekspedisi" placeholder="Ekspedisi">
              </div>
            </div>
          ...
          <div class="modal-footer">
            ...
            <div class="col-sm-12 text-right mt-2 mb-1">
              <button type="button" class="btn btn-primary" value="Simpan" id="btnsubmit" name="btnsubmit" onclick="f_simpansj()">Submit</button>
            </div>
...
@section('page-script')
  ...
  <script>
      ...
      function f_loadtable(){
          ...
          let link = "/penjualan/surat-jalan/list" +
              "?client=" + client;
      ...
      function f_suratjalan(idpenjualan,encryptid,kodesj){
          if(kodesj == ""){
      ...
      function f_simpansj(){
          ...
          $.post(link,{tanggal:tanggal, idpenjualan: idpenjualan, ekspedisi: ekspedisi, alamat: alamat, encryptid: encryptid, _token: '{{csrf_token()}}'})
              .done(function(data){
                  $("#modal3").modal('hide');
