...
@section('title', 'Pelunasan Sebagian Piutang Penjualan')
@section('page-title', 'Pelunasan Sebagian Piutang Penjualan')
...
@section('page-script')
  ...
  <script>
    ...
    function f_loadtable(){
      let link = "/penjualan/piutang-sebagian/list";
    ...
    function f_prosespelunasan(id,sisapiutang){
      let nominal = prompt('Input Nominal Pelunasan : ');
      ...
      if (isNaN(nominal)){
          ...
          if(nominal > sisapiutang || nominal < 0){
              toastr.error('Pelunasan tidak bisa lebih besar dari total Piutang..', 'Gagal', { positionClass: 'toast-top-right', containerId: 'toast-top-right', "closeButton": true });
          }else{
              var $body = $('body');
              ...
              let link = "/penjualan/piutang-sebagian/pelunasan"; // Link default untuk simpan
