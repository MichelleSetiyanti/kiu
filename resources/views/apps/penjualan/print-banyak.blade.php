              ...
              @if($penjualan->sumpajak == 0)
                ...
                <div class="row gutters decoration">
                  ...
                  <table style="width:50%">
                    <tr>
                      <td style="text-transform: uppercase;font-size:20px;"> PONTIANAK, {{ Carbon\Carbon::createFromFormat('Y-m-d', $penjualan->tanggal_inv)->isoFormat('D MMMM Y') }} </td>
                    </tr>
                    <tr>
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <table class="tabel m-0" style="border:1px solid black !important;">
                      ...
                      <tr>
                        ...
                        <th style="text-align:center;font-weight:bold;">HARGA SATUAN (Rp)</th>
                      ...
                      @foreach($penjualandetails ?? '' as $penjualandetail)
                        <tr>
                          <td style="text-align:center;">{{ number_format($penjualandetail->totaljual,2,',','.') }} {{ strtoupper($penjualandetail->satuanbarang) }}</td>
                          ...
                          <td style="text-align:right;">{{ number_format(($penjualandetail->totaljual * ($penjualandetail->harga - $penjualandetail->diskon - $penjualandetail->diskon_paket - $penjualandetail->diskon_extra)),0,',','.') }}</td>
                        </tr>
                      @endforeach
                      </tbody>
                      <tfoot>
                      @if($penjualan->dp > 0)
                        ...
                        <tr>
                          ...
                          <td style="text-align:right;font-weight: bold;">{{ number_format($penjualan->grandtotal - $penjualan->dp,0,',','.') }}</td>
                        </tr>
                      @else
                        <tr>
                ...
                <div class="row gutters">
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <table class="tabel pajak m-0" style="border:1px solid black !important;">
                      ...
                      <tfoot>
                      <tr>
                        <td @if($penjualan->sumdp > 0) rowspan="4" @else rowspan="3" @endif colspan="3">KETERANGAN : {!! nl2br($penjualan->keterangan) !!} </td>
                        <td style="text-align:right;font-weight: bold;">Sub Total (Rp) </td>
                        <td style="text-align:right;font-weight: bold;">{{ number_format($penjualan->sumsubtotal,0,',','.') }}</td>
                      </tr>
                      <tr>
                        <td style="text-align:right;font-weight: bold;"> Pajak 11% </td>
                        <td style="text-align:right;font-weight: bold;">{{ number_format($penjualan->sumpajak,0,',','.') }}</td>
                      </tr>
                      @if($penjualan->sumdp > 0)
                      <tr>
                        <td style="text-align:right;font-weight: bold;"> Down Payment </td>
                        <td style="text-align:right;font-weight: bold;">{{ number_format($penjualan->sumdp,0,',','.') }}</td>
                      </tr>
                      <tr>
                        <td style="text-align:right;font-weight: bold;"> Total (Rp) </td>
                        <td style="text-align:right;font-weight: bold;">{{ number_format($penjualan->sumgrandtotal - $penjualan->sumdp,0,',','.') }}</td>
                      </tr>
                      @else
                        <tr>
                          <td style="text-align:right;font-weight: bold;"> Total (Rp) </td>
                          <td style="text-align:right;font-weight: bold;">{{ number_format($penjualan->sumgrandtotal,0,',','.') }}</td>
                        </tr>
                      @endif
                      <tr>
                        <td colspan="5">Syarat Pembayaran : @if($penjualan->pembayaran == "Credit") <b> KREDIT {{ $penjualan->termin }} HARI </b> @endif </td>
                      </tr>
                      <tr>
                        <td colspan="5" style="text-transform: capitalize">Terbilang (Rp) : {{  terbilang($penjualan->sumgrandtotal) }} </td>
                      </tr>
                      </tfoot>
                    </table>
                    <table class="table m-0" style="border:1px solid black !important;">
                      <tbody>
                      <tr>
                        <td style="width:33.33%;text-align:center;padding-bottom:140px;">Nama dan Tanda Tangan Penerima</td>
                        <td style="width:33.33%;text-align:center;padding-bottom:140px;">Tanda Tangan Yang Menyerahkan</td>
                        <td style="width:33.33%;text-align:center;padding-bottom:140px;">Hormat Kami</td>
                      </tr>
                      </tbody>
                    </table>
                  </div>
