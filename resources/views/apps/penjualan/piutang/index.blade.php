...
@section('title', 'Pelunasan Piutang Penjualan')
@section('page-title', 'Pelunasan Piutang Penjualan')
...
@section('page-script')
  ...
  <script>
    ...
    function f_loadtable(){
      let link = "/penjualan/piutang/list";
    ...
    function f_prosespelunasan(){
      ...
      $.each(tblData, function(i, val) {
          ...
          if(Countrow == tblData.length){
              let link = "/penjualan/piutang/pelunasan"; // Link default untuk simpan
