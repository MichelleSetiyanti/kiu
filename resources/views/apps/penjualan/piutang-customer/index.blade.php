    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel3">Masukkan Tanggal Cetak</h4>
            ...
            <div class="modal-body" style="height:300px;">
                <div class="row">
                    <div class="col-sm-12 mb-1 data-field-col">
                        ...
                        <input type="text" class="form-control date" name="tanggalcetak" id="tanggalcetak">
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <div class="col-sm-12 text-right mt-2 mb-1">
                    <button type="button" class="btn btn-primary" value="Simpan" id="btnsubmit" name="btnsubmit"
                        onclick="f_printKwitansi()">Submit</button>
                </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#tanggalcetak").pickadate('picker').set('select', new Date());
    ...
    function f_printKwitansi() {
        ...
        var nofaktur = [];
        let konsumen = $("#konsumen").val();
        let tanggalcetak = $("[name=tanggalcetak_submit]").val();
        console.log(tanggalcetak);
