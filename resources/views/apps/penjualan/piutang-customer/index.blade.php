  ...
  <section id="data-list-view" class="data-list-view-header card" style="padding:25px 15px;">
    ...
    <div class="row">
      ...
      <div class="col-sm-12 col-md-12">
        <button type="button" onclick="location.href='/penjualan/piutang-customer/list-data'" class="btn bg-gradient-info waves-effect waves-light mt-2 mb-2" style="margin-right:15px;"> <i class="feather icon-list" style="margin-right:8px;"></i> Lihat History Pelunasan Piutang </button>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-12 col-md-6 mb-2 hidden">
        ...
        <input type="text" class="form-control" name="potongdp" id="potongdp" value="0" onfocus="f_tonumber(this.id)" onblur="f_tocurrency(this.id);" required>
      </div>

      <div class="col-sm-12 col-md-12 mb-2">
        <label for="totalpelunasan"> <b>Total Pelunasan</b></label>
        <input type="text" class="form-control" name="totalpelunasan" id="totalpelunasan" value="0" onfocus="f_tonumber(this.id)" onblur="f_tocurrency(this.id);" style="font-weight:bold;font-size:22px;color:green;" readonly>
      </div>
    ...
    function f_prosespelunasan(){
      ...
      $.each(tblData, function(i, val) {
          ...
          if(Countrow == tblData.length){
              ...
              $.post(link,{datas:items,akun:akuns,utangdp:utangdp,potongdp:potongdp,konsumen:konsumen, _token: '{{csrf_token()}}'})
                  .done(function(data){
                      if(data != "gagal"){
