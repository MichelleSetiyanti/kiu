...
if ($nilai < 12) { $temp=' ' . $huruf[$nilai]; } elseif ($nilai < 20) { $temp=penyebut($nilai - 10) . ' belas' ; }
    ...
    $hasil=trim(penyebut($nilai)); } return $hasil . ' Rupiah' ; } @endphp <!doctype html>
    ...
    <head>
        ...
        <title>Nota Pelunasan Penjualan - {{ $kode . ' - ' . $nama }} </title>
                                        ...
                                        <table style="width:100%;border:1px solid black;">
                                            <tr>
                                                <td style="font-weight:bold;padding-left:15px;padding-top:10px;width:50%;border: 1px solid black;"
                                                    rowspan="2">
                                                    {{-- <img style="width:60%"
                                                        src="{{ asset('/images/logo/kop_kiu.png') }}" /> --}}
                                                </td>
                                                <td
                                            ...
                                            <tr>
                                                <td style="border: 1px solid black;font-size:24px;" colspan="2">
                                                    <table
                                                        ...
                                                        <tr>
                                                            <td style="width:200px;vertical-align: top;"> Sudah Terima
                                                                Dari
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="text-transform: capitalize;vertical-align: top;">
                                                                {{ terbilang($nominal) }} </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="vertical-align: top;"> Untuk Pembayaran </td>
                                                            <td style="vertical-align: top;"> : </td>
                                                            <td style="vertical-align: top;"> Sesuai Dengan Faktur
                                                                Terlampir
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td> </td>
                                                            <td> </td>
                                                            <td> ( Faktur Penjualan {{ implode(', ', $nofaktur) }} )
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="3">
                                                    ...
                                                    <div
                                                        ...
                                                        $pinjamanpenampung->tanggal)->isoFormat('D MMMM Y') }}
                                                    </div>
    ...
    <script>
        ...
        function f_simpan() {
            ...
            html2canvas($(".html-content")[0], {
                ...
                pdf.save(
                    "Nota Pelunasan Penjualan - {{ $kode . ' - ' . $nama }}.pdf"
                );
                $(".no-print").show();
            });
        }
