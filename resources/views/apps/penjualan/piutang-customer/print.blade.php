...
{{--                      <img style="width:60%" src="{{ asset('/images/logo/kop_kiu.png') }}" />--}}
                  ...
                  <tr>
                    <td style="font-weight:bold;border: 1px solid black;font-size:36px;text-align:center;"> {{ $bayarpiutang->kode }} </td>
                  </tr>
                  <tr>
                    <td style="border: 1px solid black;font-size:24px;" colspan="2">
                      <table style="width:90%;margin-left:5%;margin-top:20px;margin-bottom:20px;">
                        <tr>
                          <td style="width:200px;vertical-align: top;"> Sudah Terima Dari </td>
                          <td style="vertical-align: top;"> : </td>
                          <td style="vertical-align: top;"> {{ $bayarpiutang->namakonsumen }} </td>
                        </tr>
                        <tr>
                          <td style="vertical-align: top;"> Uang Sejumlah </td>
                          <td style="vertical-align: top;"> : </td>
                          <td style="text-transform: capitalize;vertical-align: top;"> {{ terbilang($bayarpiutang->nominal) }} </td>
                        </tr>
                        <tr>
...
<script>
  ...
  function f_simpan(){
    ...
    html2canvas($(".html-content")[0],{scale:4}).then(function (canvas) {
      ...
      pdf.save("Nota Pelunasan Penjualan - {{ $bayarpiutang->kode." - ".$bayarpiutang->namakonsumen }}.pdf");
      $(".no-print").show();
    });
  }
</script>
