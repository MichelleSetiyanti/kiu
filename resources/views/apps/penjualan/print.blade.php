                ...
                <div class="row gutters">
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <table class="tabel m-0" style="border:1px solid black !important;">
                      ...
                      @if($penjualan->dp > 0)
                        <tr>
                          <td colspan="4" rowspan="3">KETERANGAN :  {!! nl2br($penjualan->keterangan) !!}</td>
                        ...
                        <tr>
                          ...
                          <td style="text-align:right;font-weight: bold;">{{ number_format($penjualan->diskon,0,',','.') }}</td>
                        </tr>
                        {{-- @endif --}}
                        <tr>
                ...
                <div class="row gutters">
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <table class="tabel m-0 pajak" style="border:1px solid black !important;">
                      ...
                      <tfoot>
                      <tr>
                        <td @if($penjualan->dp > 0) rowspan="4" @else rowspan="3" @endif colspan="3">KETERANGAN : {!! nl2br($penjualan->keterangan) !!} </td>
                        <td style="text-align:right;font-weight: bold;">Sub Total (Rp) </td>
                        <td style="text-align:right;font-weight: bold;">{{ number_format($penjualan->subtotal,0,',','.') }}</td>
                      </tr>
                      <tr>
                        <td style="text-align:right;font-weight: bold;"> Pajak 11% </td>
                        <td style="text-align:right;font-weight: bold;">{{ number_format($penjualan->pajak,0,',','.') }}</td>
                      </tr>
                      @if($penjualan->dp > 0)
                      <tr>
                        <td style="text-align:right;font-weight: bold;"> Down Payment </td>
                      ...
                      <tr>
                        <td colspan="5" style="text-transform: capitalize">Terbilang (Rp) : {{  terbilang($penjualan->grandtotal) }} </td>
                      </tr>
                      </tfoot>
                    </table>
