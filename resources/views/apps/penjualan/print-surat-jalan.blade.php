                        ...
                        <div class="invoice-container">
                            <div class="invoice-header">
                                ...
                                @else
                                    <div class="row gutters decoration space-line">
                                        ...
                                        <p
                                            style="font-size:26px; width:35%;text-align:center;margin-top:10px;margin-left:25%;">
                                            <u>SURAT PENGANTAR</u> <br />{{ $penjualan->kode_sj }}
                                        </p>
                            ...
                            @if ($penjualan->pajak == 0)
                                ...
                                <div class="invoice-footer">
                                    <!-- Row start -->
                                    <div class="row gutters decoration naikin" style="font-size:15px;">
