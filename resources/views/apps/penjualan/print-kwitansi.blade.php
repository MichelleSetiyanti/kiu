                                        ...
                                        <tr>
                                            <td style="border: 1px solid black;font-size:24px;" colspan="2">
                                                <table
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: top;width:200px;"> Sudah Terima Dari
                                                        </td>
                                                        <td style="vertical-align: top;"> : </td>
                                                        <td style="vertical-align: top;"> {{ $penjualan->namakonsumen }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td style="vertical-align: top;text-transform: capitalize;">
                                                            {{ terbilang($penjualan->grandtotal) }} </td>
                                                    </tr>
                                                    <tr>
...
<script>
    ...
    function f_simpan() {
        ...
        html2canvas($(".html-content")[0], {
            ...
            pdf.save(
                "Nota Pelunasan Penjualan - {{ $penjualan->kode . ' - ' . $penjualan->namakonsumen }}.pdf");
            $(".no-print").show();
        });
    }
</script>
