              ...
              <div class="row gutters no-print decoration">
                ...
                <div class="row gutters decoration">
                  ...
                  <table style="width:100%;">
                    <tr>
                      <td style="text-transform: uppercase;font-size:20px;width:100%;text-align:center;"> PONTIANAK, {{ Carbon\Carbon::createFromFormat('Y-m-d', $penjualan->tanggal_inv)->isoFormat('D MMMM Y') }} </td>
                    </tr>
                    <tr>
                      <td style="text-transform: uppercase;font-size:20px;font-weight: bold;width:100%;text-align:center;"> {{ $penjualan->namakonsumen }} </td>
                    </tr>
                  </table>
                </div>
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    @foreach($penjualandetails ?? '' as $penjualandetail)
                      <div class="col-md-10 offset-md-1">
                        <div class="row">
                          <div class="col-md-8"> {{ $penjualandetail->namabarang }} </div>
                          <div class="col-md-4 text-right"> {{ number_format($penjualandetail->subtotal,0,',','.') }} </div>
                        </div>
                      </div>
                      <div class="col-md-10 offset-md-1">
                        <div class="row">
                          <div class="col-md-12"> {{ number_format($penjualandetail->total_jual,2,',','.') }} {{ strtoupper($penjualandetail->satuanbarang) }} x {{ number_format($penjualandetail->harga - $penjualandetail->diskon - $penjualandetail->diskon_paket - $penjualandetail->diskon_extra,0,',','.') }} </div>
                        </div>
                      </div>
                    @endforeach
                    ...
                    <div class="col-md-10 offset-md-1">
                      <div class="row">
                        <div class="col-md-8 text-right" style="font-weight:bold;"> Grand Total </div>
                        <div class="col-md-4 text-right" style="font-weight:bold;"> {{ number_format($penjualan->grandtotal,0,',','.') }} </div>
                      </div>
                    </div>
