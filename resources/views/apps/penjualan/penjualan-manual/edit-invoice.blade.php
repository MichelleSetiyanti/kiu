                                        ...
                                        <div class="col-sm-12 col-md-6 mb-1">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 col-md-6 mb-1">
                                                    <label>Kode SJ</label>
                                                    <input type="text" class="form-control"
                                                        value="{{ $penjualan->kode_sj }}" readonly>
                                                </div>

                                                <div class="col-sm-12 col-md-6 mb-1">
                                                    <label>Kode INV</label>
                                                    <input type="text" class="form-control"
                                                        value="{{ $penjualan->kode_inv }}" readonly>
                                                </div>
                                        ...
                                        <div class="col-sm-12 col-md-6 mb-1">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 col-md-6 mb-1">
                                                    ...
                                                    <input type="text" class="form-control" readonly
                                                        value="{{ Carbon\Carbon::createFromFormat('Y-m-d', $penjualan->tanggal_inv)->isoFormat('D MMMM Y') }}">
                                                </div>
    ...
    <script>
        ...
        function f_addtemp() {
            ...
            if ((produks != "kosong" && action == "Simpan") || action == "Edit") {
                ...
                if (action == "Simpan") {
                    ...
                    $.post('/penjualan/penjualan-manual/update-detil-invoice', {
                            id_temp: id_temp,
                            idpenjualan: idpenjualan,
                            totaljual: totaljual,
                            harga: harga,
                        ...
                        .done(function(data) {
                            if (data == "berhasil") {
                                ...
                                f_clear();
                                toastr.error('Stock Kurang.', 'Warning', {
                                    positionClass: 'toast-top-right',
                                    containerId: 'toast-top-right',
                                    "closeButton": true
                                });
        ...
        function f_deletetemp(param) {
            Swal.fire({
                ...
                if (result.value) {
                    let link = "/penjualan/penjualan-manual/drop-detil-invoice"; // Link untuk hapus
        ...
        function f_prosesdata(param) {
            ...
            $.post('/penjualan/penjualan-manual/proses-edit-invoice', {
                    idpenjualan: idpenjualan,
