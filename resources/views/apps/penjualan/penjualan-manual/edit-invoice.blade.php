...
@section('title', 'Edit Data Invoice')
@section('page-title', 'Edit Data Invoice')
                  ...
                  <div class="row mb-1">
                    ...
                    <div class="col-sm-12 col-md-6 mb-1">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 mb-1">
                          <label>Kode SO</label>
                          <input type="text" class="form-control" value="{{ $penjualan->kode }}" readonly>
                        </div>

                        <div class="col-sm-12 col-md-6 mb-1">
                          <label>Kode SJ</label>
                          <input type="text" class="form-control" value="{{ $penjualan->kode_sj }}" readonly>
                        </div>

                        <div class="col-sm-12 col-md-6 mb-1">
                          <label>Kode INV</label>
                          <input type="text" class="form-control" value="{{ $penjualan->kode_inv }}" readonly>
                        </div>

                        <div class="col-sm-12 col-md-6 mb-1">
                          <label>Nama Konsumen</label>
                          <select class="form-control select" name="konsumen" id="konsumen" onchange="f_updatekonsumen(this.value)">
                        ...
                        <div class="col-sm-12 col-md-6 mb-1">
                          ...
                          <input type="text" class="form-control date" name="tanggal" id="tanggal" onchange="f_ubahtanggal()" required>
                        </div>

                        <div class="col-sm-12 col-md-6 mb-1">
                          <label>Tanggal SJ</label>
                          <input type="text" class="form-control" readonly value="{{ Carbon\Carbon::createFromFormat('Y-m-d', $penjualan->tanggal_sj)->isoFormat('D MMMM Y') }}" >
                        </div>
                    ...
                    <div class="col-sm-12 col-md-6 mb-1">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12 mb-1">
                          ...
                          <textarea class="form-control" name="keterangan" rows="4" id="keterangan">{{ $penjualan->keterangan }}</textarea>
                        </div>

                        <div class="col-sm-12 col-md-6 mb-1">
                          <label>Tanggal INV</label>
                          <input type="text" class="form-control" readonly value="{{ Carbon\Carbon::createFromFormat('Y-m-d', $penjualan->tanggal_inv)->isoFormat('D MMMM Y') }}" >
                        </div>

                        <div class="col-sm-12 col-md-6 mb-1">
                          <label>Metode Pembayaran</label>
                          <select class="form-control" name="pembayaran" id="pembayaran" readonly="">
                            <option value="Cash">Cash</option>
                            <option value="Credit">Credit</option>
                          </select>
                          <input type="text" class="form-control hidden" value="{{ $penjualan->pembayaran }}" readonly>
                        </div>
  ...
  <section id="data-list-view" class="data-list-view-header card" style="padding:25px 15px;">
    ...
    <div class="col-md-12">
      <div class="row">
        ...
        <div class="col-sm-12 col-md-3">
          ...
          <select class="form-control select" name="produks" id="produks" onchange="f_updatedetail()">
            ...
            @foreach($produks as $produk)
              <option id="{{ $produk->nama }}#{{ $produk->harga }}" data-foo="{{ number_format($produk->harga,0,",",".") }}" value="{{ $produk->id }}">{{ $produk->nama }} - {{ $produk->kode }}</option>
            @endforeach
          </select>
        </div>
        ...
        <div class="col-sm-12 col-md-2">
          <div class="row">
            ...
            <div class="col-sm-3 col-md-3 pl-0">
              <button type="button" id="btnhistory" name="btnhistory" style="padding:9px;margin-top:20px;" class="btn bg-gradient-warning waves-effect waves-light" data-toggle="tooltip" title="Lihat History Harga" onclick="historyharga();"> <i class="feather icon-rotate-cw" style="font-size:20px;"></i> </button>
            </div>
        ...
        <div class="col-sm-12 col-md-1 pl-0">
          ...
          <input type="text" class="form-control" name="totaljual" id="totaljual" value="0" onfocus="f_tonumber(this.id)" onblur="f_tocurrency(this.id);">
        </div>
        ...
        <div class="col-sm-12 col-md-4">
          <div class="row">
            ...
            <div class="col-sm-12 col-md-4 pl-0">
              ...
              <input type="text" class="form-control" name="diskon" id="diskon" value="0" onfocus="f_tonumber(this.id)" onblur="f_tocurrency(this.id);">
            </div>

            <div class="col-sm-12 col-md-4 pl-0">
              <label for="diskonpaket">Diskon Paket</label>
              <input type="text" class="form-control" name="diskonpaket" id="diskonpaket" value="0" onfocus="f_tonumber(this.id)" onblur="f_tocurrency(this.id);">
            </div>

            <div class="col-sm-12 col-md-4 pl-0">
              <label for="diskonextra">Diskon Extra</label>
              <input type="text" class="form-control" name="diskonextra" id="diskonextra" value="0" onfocus="f_tonumber(this.id)" onblur="f_tocurrency(this.id);">
            </div>
        ...
        <div class="col-sm-12 col-md-1 pl-0 hidden">
          ...
          <input type="text" class="form-control" name="potonganitem" id="potonganitem" value="0" onfocus="f_tonumber(this.id)" onblur="f_tocurrency(this.id);">
        </div>
    ...
    <div class="col-md-12 mt-1">
      ...
      <div class="row mr-1">
        ...
        <div class="col-md-6 mt-1 offset-3 col-sm-12 text-right"> <h4 style="margin:6px auto;"> Diskon Nota : </h4> </div>
        <div class="col-md-3 mt-1 col-sm-12">
          <input type="text" class="form-control" style="font-weight: bold;" name="diskonnota" id="diskonnota" value="0" onfocus="f_tonumber(this.id)" onblur="f_tocurrency(this.id);f_hitungtotal();">
        </div>

        <div class="col-md-6 mt-1 offset-3 col-sm-12 text-right"> <h4 style="margin:6px auto;"> Pajak : </h4> </div>
        ...
        <div class="col-md-2 mt-1 col-sm-9">
          <input type="text" class="form-control" style="font-weight: bold;" name="pajak" id="pajak" value="0" onfocus="f_tonumber(this.id)" onblur="f_tocurrency(this.id);f_hitungtotal();" readonly>
        </div>

        <div class="col-md-6 mt-1 offset-3 col-sm-12 text-right hidden"> <h4 style="margin:6px auto;"> Biaya Tambahan : </h4> </div>
        <div class="col-md-3 mt-1 col-sm-12 hidden">
          <input type="text" class="form-control" style="font-weight: bold;" name="biayatambahan" id="biayatambahan" value="0" onfocus="f_tonumber(this.id)" onblur="f_tocurrency(this.id);f_hitungtotal();">
        </div>

        <div class="col-md-6 mt-1 offset-3 col-sm-12 text-right"> <h4 style="margin:6px auto;"> DP : </h4> </div>
        <div class="col-md-3 mt-1 col-sm-12">
          <input type="text" class="form-control" style="font-weight: bold;" name="downpayment" id="downpayment" value="0" onfocus="f_tonumber(this.id)" onblur="f_tocurrency(this.id);" readonly>
        </div>
        ...
        <div class="col-md-12 mt-1 col-sm-12 text-right">
          <button type="button" id="btnsimpan" name="btnsimpan" class="btn bg-gradient-success waves-effect waves-light" onclick="f_prosesdata('selesai')"> Selesai Input Data </button>
        </div>
            ...
            <div class="row mb-1">
              ...
              <div class="col-sm-12 col-md-6">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12 col-md-12 mb-1">
                    ...
                    <input type="text" class="form-control" id="kodedetil" value="" readonly>
                  </div>

                  <div class="col-sm-12 col-md-12 mb-1">
                    <label>Nama Barang</label>
                    <input type="text" class="form-control" id="namadetil" value="" readonly>
                  </div>

                  <div class="col-sm-12 col-md-12 mb-1">
                    <label>Qty</label>
                    <input type="text" class="form-control" id="totaljualdetil" value="0" onfocus="f_tonumber(this.id)" onblur="f_tocurrency(this.id)">
                  </div>

                  <div class="col-sm-12 col-md-12 mb-1">
                    <label>Harga Jual</label>
                    <input type="text" class="form-control" id="nominaldetil" value="0" onfocus="f_tonumber(this.id)" onblur="f_tocurrency(this.id)">
                  </div>
              ...
              <div class="col-sm-12 col-md-6">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12 col-md-12 mb-1">
                    <label>Diskon</label>
                    <input type="text" class="form-control" id="diskondetil" value="0" onfocus="f_tonumber(this.id)" onblur="f_tocurrency(this.id)">
                  </div>

                  <div class="col-sm-12 col-md-12 mb-1">
                    <label>Diskon Paket</label>
                    <input type="text" class="form-control" id="diskonpaketdetil" value="0" onfocus="f_tonumber(this.id)" onblur="f_tocurrency(this.id)">
                  </div>

                  <div class="col-sm-12 col-md-12 mb-1">
                    <label>Diskon Extra</label>
                    <input type="text" class="form-control" id="diskonextradetil" value="0" onfocus="f_tonumber(this.id)" onblur="f_tocurrency(this.id)">
                  </div>
                  ...
                  <div class="col-sm-12 col-md-12 mb-1">
                    <button type="button" class="btn bg-gradient-success waves-effect waves-light" onclick="f_addtemp()"> Simpan Perubahan </button>
                  </div>
  ...
  <script>
      ...
      function f_ubahtanggal(){
          ...
          if(tanggalsubmit != tanggal){
              $.post('/penjualan/penjualan-manual/update-tanggal',{idpenjualan: idpenjualan, tanggal: tanggalsubmit, _token: '{{csrf_token()}}'})
                  .done(function(data){
                      if(data != "gagal"){
                          location.reload();
                      }
      ...
      function f_updatekonsumen(idbaru){
          if(idbaru != konsumen){
              $.post('/penjualan/penjualan-manual/update-konsumen',{idpenjualan: idpenjualan, konsumen: idbaru, _token: '{{csrf_token()}}'})
                  .done(function(data){
                      if(data != "gagal"){
                          location.reload();
                      }
      ...
      function f_loadtable(){
          let dataListView = $(".data-list-view").DataTable({
              ...
              columns: [
                  ...
                  {data: 'diskon_paket', name: 'diskon_paket', render: $.fn.dataTable.render.number( '.', ',', 2 )},
                  {data: 'diskon_extra', name: 'diskon_extra', render: $.fn.dataTable.render.number( '.', ',', 2 )},
      ...
      function f_addtemp(){
          ...
          if((produks != "kosong" && action == "Simpan") || action == "Edit"){
              ...
              if(action == "Simpan"){
                  ...
                  $.post('/penjualan/penjualan-manual/update-detil',{id_temp: id_temp, idpenjualan: idpenjualan, totaljual: totaljual, harga: harga, catatan: catatan, diskon: diskon, diskonpaket: diskonpaket, diskonextra: diskonextra, _token: '{{csrf_token()}}'})
                      .done(function(data){
                          if(data == "berhasil"){
                              f_clear();
      ...
      function f_edittemp(param){
          ...
          $.post(link, {id_temp: param, _token: '{{csrf_token()}}'})
              .done(function (data) {
      ...
      function f_updatedetail(){
          ...
          if(produk != "kosong") {
              ...
              $("#totaljual").val(accounting.formatNumber(1, 2, ".", ","));
          }
      }
      ...
      function f_hitungtotal(){
          $.post('/penjualan/penjualan-manual/request-total-detil',{idpenjualan: idpenjualan, _token: '{{csrf_token()}}'})
              .done(function(data){
                  let pecah = data.split("|");
                  if (pecah[0] == "ada") {
                      ...
                      $("#totalakhir").val(accounting.formatMoney((subtotal+biayatambahan-diskon)+pajak, "Rp ", 0, ".", ","));
                  }
              });
      }
      ...
      function f_prosesdata(param){
        ...
        $.post('/penjualan/penjualan-manual/proses-edit-invoice',{idpenjualan: idpenjualan, kodepenjualan: kodepenjualan, downpayment: downpayment, keterangan: keterangan, subtotal: subtotal, diskon: diskon, pajak: pajak, biayatambahan: biayatambahan, totalakhir: totalakhir, action: action, akunpembayaran: akun, pembayaran: pembayaran, _token: '{{csrf_token()}}'})
          .done(function(data){
            if(data == "berhasil"){
              Swal.fire({
                title: 'Informasi',
      ...
      function ubahpembayaran(value){
          ...
          if(value != pembayaranlama){
              $.post('/penjualan/penjualan-umum/ubah-metode-pembayaran',{idpenjualan: idpenjualan, pembayaran: value, _token: '{{csrf_token()}}'})
                  .done(function(data){
                      location.reload();
                  });
          }
