                    ...
                    <div class="col-sm-12 col-md-6 mb-1">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 mb-1">
                          ...
                          <select class="form-control" name="pembayaran" id="pembayaran" onchange="ubahpembayaran(this.value)">
  ...
  <section id="data-list-view" class="data-list-view-header card" style="padding:25px 15px;">
    ...
    <div class="col-md-12 mt-1">
      ...
      <div class="row mr-1">
        ...
        <div class="col-md-3 mt-1 col-sm-12">
          <input type="text" class="form-control" style="font-weight: bold;" name="downpayment" id="downpayment" value="0" onfocus="f_tonumber(this.id)" onblur="f_tocurrency(this.id);">
        </div>
        ...
        <div class="col-md-12 mt-1 col-sm-12 text-right">
          <button type="button" id="btnsimpan" name="btnsimpan" class="btn bg-gradient-info waves-effect waves-light mr-2" onclick="f_prosesdata('belum selesai')"> Simpan Sementara </button>
...
@section('page-script')
  ...
  <script>
    ...
    function f_prosesdata(param){
      ...
      $.post('/penjualan/penjualan-manual/proses-detil',{idpenjualan: idpenjualan, kodepenjualan: kodepenjualan, downpayment: downpayment, keterangan: keterangan, subtotal: subtotal, diskon: diskon, pajak: pajak, biayatambahan: biayatambahan, totalakhir: totalakhir, akunpembayaran: akun, pembayaran: pembayaran, action: action, _token: '{{csrf_token()}}'})
        .done(function(data){
          if(data == "berhasil"){
            Swal.fire({
              title: 'Informasi',
