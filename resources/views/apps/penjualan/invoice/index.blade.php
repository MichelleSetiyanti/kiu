                    ...
                    <div class="modal-footer">
                        ...
                        <div class="col-sm-12 text-right mt-2 mb-1">
                            <button type="button" class="btn btn-primary" value="Simpan" id="btnsubmit"
                                name="btnsubmit" onclick="f_simpaninv()">Submit</button>
                        </div>
...
@section('page-script')
    ...
    <script>
        ...
        function f_editKet(param) {
            let id = param;
            let keterangan = $("#keterangan").val();

            $.post("/penjualan/invoice/edit-ket", {
                    id: id,
        ...
        function f_simpaninv() {
            ...
            $.post("/penjualan/invoice/ceklimit", {
        ...
        function f_editinvoice(idpenjualan, encryptid) {
            ...
            $.post('/penjualan/penjualan-manual/cek-password', {
                    idpenjualan: idpenjualan,
                    password: password,
                    _token: '{{ csrf_token() }}'
                })
