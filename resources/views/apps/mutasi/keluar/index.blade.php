...
@section('title', 'Input Pengurangan Stok Barang')
@section('page-title', 'Input Pengurangan Stok Barang')
      ...
      <div class="add-new-data">
        <form class="needs-validation" id="form" novalidate autocomplete="false">
          <div class="div mt-2 px-2 d-flex new-data-title justify-content-between">
            <div>
              <h4 class="text-uppercase proposal">Input Pengurangan Barang</h4>
            </div>
            ...
            <div class="data-fields px-2 mt-1">
              <div class="row">
                ...
                <div class="col-sm-12 data-field-col selesaikan">
                  <label for="qty">Qty Pengurangan</label>
...
@section('page-script')
  ...
  <script>
    ...
    function getstokbarang(param){
        let link = "/mutasi/masuk/getstok"; // Ubah link untuk update
    ...
    function f_loadtable(){
      ...
      let dataListView = $(".data-list-view").DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: "/mutasi/keluar/list?tanggal="+tanggal,
        columns: [
        ...
        buttons: [
          {
            text: "<i class='feather icon-plus'></i> Tambah Pengurangan Stok",
            action: function () {
    ...
    function f_edit(param){
      let link = "/mutasi/keluar/request-data"; // Link untuk request data
    ...
    function f_delete(param){
      Swal.fire({
        ...
        if (result.value) {
          let link = "/mutasi/keluar/drop"; // Link untuk hapus
