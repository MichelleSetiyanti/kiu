...
@section('title', 'Input Penambahan Stok Barang')
@section('page-title', 'Input Penambahan Stok Barang')
      ...
      <div class="add-new-data">
        <form class="needs-validation" id="form" novalidate autocomplete="false">
          <div class="div mt-2 px-2 d-flex new-data-title justify-content-between">
            <div>
              <h4 class="text-uppercase proposal">Input Penambahan Barang</h4>
            </div>
            ...
            <div class="data-fields px-2 mt-1">
              <div class="row">
                ...
                <div class="col-sm-12 data-field-col selesaikan">
                  <label for="qty">Qty Penambahan</label>
  ...
  <script>
    ...
    function f_loadtable(){
      ...
      let dataListView = $(".data-list-view").DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: "/mutasi/masuk/list?tanggal="+tanggal,
        columns: [
        ...
        buttons: [
          {
            text: "<i class='feather icon-plus'></i> Tambah Penambahan Stok",
            action: function () {
    ...
    function f_edit(param){
      let link = "/mutasi/masuk/request-data"; // Link untuk request data
    ...
    function f_delete(param){
      Swal.fire({
        ...
        if (result.value) {
          let link = "/mutasi/masuk/drop"; // Link untuk hapus
