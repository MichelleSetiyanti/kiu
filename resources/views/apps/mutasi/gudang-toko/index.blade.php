...
@section('title', 'Mutasi Stock Barang Pabrik ke Toko')
@section('page-title', 'Mutasi Stock Barang Pabrik ke Toko')
...
@section('page-script')
  ...
  <script>
    ...
    function f_simpan(param){
      ...
      if (empty == false) {
        let link = "/mutasi/gudang-toko/store"; // Link default untuk simpan
        let data = $("#form").serialize();

        let qty = accounting.unformat($("#qty").val() , ',');

        if(param == "Edit"){
          link = "/mutasi/gudang-toko/update"; // Ubah link untuk update
        }
    ...
    function f_edit(param){
      let link = "/mutasi/gudang-toko/request-data"; // Link untuk request data
    ...
    function f_delete(param){
      Swal.fire({
        ...
        if (result.value) {
          let link = "/mutasi/gudang-toko/drop"; // Link untuk hapus
