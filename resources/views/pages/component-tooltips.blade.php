              ...
              <div class="row">
                ...
                <div class="row">
                  <div class="col-sm-12 data-field-col">
                    ...
                    <input type="text" class="form-control" name="penempatan" id="penempatan" required>
                  ...
                  <div class="col-sm-12 data-field-col">
                    ...
                    <textarea class="form-control" name="deskripsi" id="deskripsi" rows="2" placeholder="Deskripsi"></textarea>
                  </div>
                  <div class="col-sm-12 data-field-col">
                    <label for="aktif"> Status Inventaris </label>
